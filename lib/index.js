...
function compile (template, compileOpts) {
  ...
  return function render (context, renderOpts) {
    ...
    var output = '<!DOCTYPE html><html><head/><body><div id="riot_content">'
      ...
      + '</div><script src="https://cdn.jsdelivr.net/riot/2.6/riot.min.js">
      </script><script src=' + compiledFileRoute + '></script><script>
      setTimeout(function () {riot.mount("#riot_content", "index",'
